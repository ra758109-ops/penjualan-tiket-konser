    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-6">
            <div class="bg-white shadow-xl rounded-2xl p-10 w-full max-w-md">
                ...
                <!-- Button -->
                <button class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg mt-6">
                    Login
                </button>

                <p class="text-center text-gray-700 mt-4">
                    Belum punya akun?
                    <a href="#" class="text-blue-600 font-semibold hover:underline">Daftar gratis di sini</a>
                </p>
            </div>
        </div>
